                ...
                <div class="hero-badge-wrap">
                    <div class="hero-badge-icon">
                        <svg class="badge-icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 748 448" width="48" height="32">
                            <style>
                                .scraft{fill:#c4b5fd;animation:scraftWave 3s ease-in-out infinite;transform-origin:center}
                                .heart{fill:#e9214b;animation:heartFloat 2.5s ease-in-out infinite;transform-origin:center}
                                @keyframes scraftWave{0%,100%{transform:rotate(0deg) scale(1)}50%{transform:rotate(5deg) scale(1.05)}}
